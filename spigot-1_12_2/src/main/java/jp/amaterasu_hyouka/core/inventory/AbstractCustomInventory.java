...
public abstract class AbstractCustomInventory implements CustomInventoryClickListener {
    ...
    protected Consumer<InventoryClickContext> getAction(int slot, Material material){
        Map<Material, Consumer<InventoryClickContext>> slotActions = actionMap.get(slot);
